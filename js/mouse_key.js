...
/*global $, glob3D, glob, cl, ml, nn, pds, curpd, requestAnimationFrame, THREE*/
...
function doKeyDown(e) {
    ...
    switch (key) {
        ...
        case "S":
            ...
            break;
        case "T":
            $("#showTrace").trigger("click");
            break;
        case "U":
            glob.gng_doUtility = !glob.gng_doUtility;
            console.log("gng_doUtility:", glob.gng_doUtility);
            break;
        case "V":
